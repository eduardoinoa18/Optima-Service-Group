...
const Footer = () => {
  ...
  return (
    <footer className="bg-optima-navy text-white mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-300">
              Professional support for taxes, immigration forms, documents, and everyday services.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="flex items-center space-x-2 text-sm text-gray-300 hover:text-optima-gold transition-colors"
                >
            ...
            <div className="mt-4">
              <a
                ...
                className="inline-flex items-center space-x-2 px-4 py-2 bg-green-600 hover:bg-green-700 rounded-lg text-sm font-medium transition-colors"
              >
