      ...
      <div className="container">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex md:hidden items-center space-x-2">
            ...
            <a href="https://wa.me/19787055509" className="text-optima-navy dark:text-white" title="WhatsApp us" aria-label="Contact us on WhatsApp" target="_blank" rel="noopener noreferrer">
