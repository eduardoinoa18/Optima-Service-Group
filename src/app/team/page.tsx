...
export const metadata: Metadata = {
  title: "Meet Our Team | Optima Service Group",
  description:
    "A dedicated group of professionals committed to delivering clear, reliable, and efficient services for our community.",
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto mb-8">
              A dedicated group of professionals committed to delivering clear,
              reliable, and efficient services for our community.
            </p>
            <Link
              href="/contact"
