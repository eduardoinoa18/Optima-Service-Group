...
export default function ParaisoInmobiliarioPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative py-28 px-4 bg-linear-to-br from-blue-700 via-blue-600 to-blue-500 text-white overflow-hidden bg-[url('/mock-beach.svg')] bg-cover bg-center">
