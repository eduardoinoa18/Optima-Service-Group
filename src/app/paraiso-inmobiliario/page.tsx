...
export default function ParaisoInmobiliarioPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative py-28 px-4 bg-linear-to-br from-blue-700 via-blue-600 to-blue-500 text-white overflow-hidden bg-[url('https://images.unsplash.com/photo-1507525428034-b723cf961d3e')] bg-cover bg-center">
