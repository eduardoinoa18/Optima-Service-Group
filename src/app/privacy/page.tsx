...
export const metadata: Metadata = {
  title: "Privacy Policy - Optima Service Group",
  description: "Privacy Policy for Optima Service Group - How we collect, use, and protect your information.",
};
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              Optima Service Group ("we," "our," or "us") is committed to protecting your privacy. 
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>Tax information (for tax preparation services)</li>
              <li>Immigration documents (for immigration form assistance)</li>
              <li>Other information relevant to the services you request</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>Send you confirmations, invoices, and administrative messages</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li><strong>Service Providers:</strong> With trusted third-party service providers who assist us in operating our website and providing services (e.g., email service, hosting)</li>
              <li><strong>Legal Requirements:</strong> When required by law or to protect our rights and comply with legal processes</li>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mt-3">
              To exercise these rights, please contact us at inoaserv@gmail.com or (978) 705-5509.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              our agreements. When your information is no longer needed, we will securely delete or anonymize it.
            </p>
          </section>
