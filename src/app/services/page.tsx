    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="-mt-10 pb-4 px-4">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-4">
          {[{title:"Impuestos & Formularios",href:"/services/tax-preparation",image:"https://images.unsplash.com/photo-1454165804606-c3d57bc86b40"},{title:"Bienes Raíces USA",href:"/real-estate",image:"https://images.unsplash.com/photo-1560518883-ce09059eeffa"},{title:"Equipo Bilingüe",href:"/team",image:"https://images.unsplash.com/photo-1552664730-d307ca884978"}].map((card)=> (
